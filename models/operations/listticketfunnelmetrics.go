...
func (e ListTicketFunnelMetricsTagMatchStrategy) ToPointer() *ListTicketFunnelMetricsTagMatchStrategy {
	return &e
}
func (e *ListTicketFunnelMetricsTagMatchStrategy) UnmarshalJSON(data []byte) error {
	...
	case "match_all":
		fallthrough
	case "exclude":
		*e = ListTicketFunnelMetricsTagMatchStrategy(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListTicketFunnelMetricsTagMatchStrategy: %v", v)
	}
}
...
func (e ListTicketFunnelMetricsGroupBy) ToPointer() *ListTicketFunnelMetricsGroupBy {
	return &e
}
func (e *ListTicketFunnelMetricsGroupBy) UnmarshalJSON(data []byte) error {
	...
	case "started_month":
		fallthrough
	case "all_time":
		*e = ListTicketFunnelMetricsGroupBy(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListTicketFunnelMetricsGroupBy: %v", v)
	}
}
...
func (l *ListTicketFunnelMetricsRequest) GetAttachedRunbooks() *string {
	if l == nil {
		return nil
	}
