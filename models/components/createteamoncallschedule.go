...
// CreateTeamOnCallScheduleStrategy - An object that specifies how the initial rotation's on-call shifts should be generated.
...
type CreateTeamOnCallSchedule struct {
	...
	// An object that specifies how the initial rotation's on-call shifts should be generated.
