...
func (s *Integrations) DeleteStatuspageConnection(ctx context.Context, connectionID string, opts ...operations.Option) (*components.IntegrationsStatuspageConnectionEntity, error) {
