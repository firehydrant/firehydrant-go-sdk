...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.791.1
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.8.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.8.0 2.791.1 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
