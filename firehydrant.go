...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.727.4
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.6.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.6.0 2.727.4 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
