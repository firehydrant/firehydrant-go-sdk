...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.656.9
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.1.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.4 2.656.9 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
