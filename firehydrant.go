...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.801.2
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.8.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.8.5 2.801.2 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
