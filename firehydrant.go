...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.684.0
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.3.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.3.2 2.684.0 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
