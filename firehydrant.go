...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.702.0
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.4.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.4.0 2.702.0 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
