...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.658.3
...
func New(opts ...SDKOption) *FireHydrant {
	sdk := &FireHydrant{
		SDKVersion: "1.1.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.1.5 2.658.3 0.0.1 github.com/firehydrant/firehydrant-go-sdk",
