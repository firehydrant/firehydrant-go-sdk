...
func (s *Communication) DeleteStatusUpdateTemplate(ctx context.Context, statusUpdateTemplateID string, opts ...operations.Option) (*components.StatusUpdateTemplateEntity, error) {
