...
* [ExportIncidentRetrospectivesMarkdown](#exportincidentretrospectivesmarkdown) - Export an incident's retrospective(s) as markdown
...
## ExportIncidentRetrospectivesMarkdown

Export incident's retrospective(s) as markdown

### Example Usage

<!-- UsageSnippet language="go" operationID="export_incident_retrospectives_markdown" method="post" path="/v1/incidents/{incident_id}/retrospectives/export_markdown" -->
```go
package main
...
func main() {
    ...
    res, err := s.Retrospectives.ExportIncidentRetrospectivesMarkdown(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
**[*components.IncidentsExportRetrospectiveMarkdownEntity](../../models/components/incidentsexportretrospectivemarkdownentity.md), error**
...
func main() {
    ...
    res, err := s.Retrospectives.UpdateRetrospectiveTemplate(ctx, "<id>", operations.UpdateRetrospectiveTemplateRequestBody{
        ...
        ReportElementsType: operations.ReportElementsTypeRetrospectiveField,
    })
    if err != nil {
        log.Fatal(err)
    }
