...
func newRoles(rootSDK *FireHydrant, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Roles {
	return &Roles{
		rootSDK:          rootSDK,
...
func (s *Roles) ListRoles(ctx context.Context, query *string, page *int, perPage *int, opts ...operations.Option) (*components.RoleEntityPaginated, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/roles")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.RoleEntityPaginated
...
// Create a new role
func (s *Roles) CreateRole(ctx context.Context, request components.CreateRole, opts ...operations.Option) (*components.PublicAPIV1RoleEntity, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PublicAPIV1RoleEntity
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// GetRole - Get a role
// Get a role
func (s *Roles) GetRole(ctx context.Context, id string, opts ...operations.Option) (*components.PublicAPIV1RoleEntity, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/roles/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Roles) UpdateRole(ctx context.Context, id string, updateRole components.UpdateRole, opts ...operations.Option) (*components.PublicAPIV1RoleEntity, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateRole", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
