...
func (s *MetricsReporting) DeleteSavedSearch(ctx context.Context, resourceType operations.DeleteSavedSearchResourceType, savedSearchID string, opts ...operations.Option) (*components.SavedSearchEntity, error) {
